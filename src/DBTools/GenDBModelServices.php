    ...
    public static function GenDBModel(): DBModel
    {
        ...
        foreach ($tables as $table) {
            ...
            foreach ($table->getColumns() as $column) {
                ...
                $columnModel->phpType = Constants::DBType2ColumnType[$columnModel->dbType] ?? 'unknown';
...
//        // 处理 $hasMany $belongsTo 关联关系
     ...
     * @return string
     */
    public static function parseFillable(array $columnNames): string
    {
     ...
     * @return string
     */
    public static function parseValidateString(array $validate): string
    {
        return implode("\n", $validate);
    }
}